...
#include "mmgpsr-packet.h"
#include "ns3/address-utils.h"
#include "ns3/packet.h"
#include "ns3/log.h"

NS_LOG_COMPONENT_DEFINE ("MMGpsrPacket");
...
TypeHeader::TypeHeader (MessageType t = MMGPSRTYPE_HELLO)
  : m_type (t),
    m_valid (true)
{
}
...
{
  static TypeId tid = TypeId ("ns3::mmgpsr::TypeHeader")
    .SetParent<Header> ()
...
{
  static TypeId tid = TypeId ("ns3::mmgpsr::HelloHeader")
    .SetParent<Header> ()
...
{
  static TypeId tid = TypeId ("ns3::mmgpsr::PositionHeader")
    .SetParent<Header> ()
